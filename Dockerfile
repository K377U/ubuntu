...
RUN \
  ...
  apt-get install -y build-essential openssh-client libsasl2-dev libldap2-dev libssl-dev jq git wget zlib1g-dev libbz2-dev liblzma-dev libncurses5-dev dh-autoreconf pkg-config autoconf && \
